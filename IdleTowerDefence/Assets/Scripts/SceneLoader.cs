    ...
    public class SceneLoader : MonoBehaviour
    {
        ...
        void Start()
        {
            if(System.IO.File.Exists(SaveLoadHelper.GetSaveGameFilePath()))
            {
                ...
                _data = new PlayerData(1, UpgradeManager.MageDamageInitial, 100, 0, UpgradeManager.MageUpgradePriceInitial, Element.Air, UpgradeManager.MageUpgradePriceInitial);
            }         
        }
