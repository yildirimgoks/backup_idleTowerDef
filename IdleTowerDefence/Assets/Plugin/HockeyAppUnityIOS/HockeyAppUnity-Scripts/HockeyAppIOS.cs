...
public class HockeyAppIOS : MonoBehaviour
{
	...
	protected const string HOCKEYAPP_CRASHESPATH = "api/2/apps/22176a5839fd4b13938448e401732358/crashes/upload";
	...
	public string appID = "22176a5839fd4b13938448e401732358";
	public string serverURL = "your-custom-server-url";

	[Header ("Authentication")]
	public AuthenticatorType authenticatorType;
	public string secret = "c8a7181363fef03fe2f97b4621697476";

	[Header ("Crashes & Exceptions")]
	public bool autoUploadCrashes = true;
